...
public class JsonProcessor {
  ...
  public void processEventsJson(String eventsJson) throws IOException {
    ...
    for (Event event : events) {
      com.isa.zajavieni.entity.fromapi.Event mapEventToEntity = eventsMapper.mapEventsApiToEntity(event);
  ...
  public void processOrganizerFile(String organizersJson) throws IOException {
    ...
    for (Organizer organizer : organizers) {
      com.isa.zajavieni.entity.fromapi.Organizer mapOrganizerToEntity = organizersMapper
